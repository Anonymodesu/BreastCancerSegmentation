"""A vanilla 3D resnet implementation. Adapted from https://github.com/JihongJu/keras-resnet3d

Based on Raghavendra Kotikalapudi's 2D implementation
keras-resnet (See https://github.com/raghakot/keras-resnet.)

No longer using stride>1 for transposed CNN layers
Added shortcut connections to the transposed CNN layers
"""
...
class Resnet3DBuilder(object):
    ...
    def build(input_shape, output_shape, block_fn, repetitions, reg_factor, mode='detection'):
        ...
        if mode == 'detection':
            ...
            deconv = Conv3DTranspose(filters=64, kernel_size=(6,6,8),
                          strides=(1,1,1), kernel_initializer='he_normal',
                          kernel_regularizer=l2(reg_factor))(deconv)
            deconv = _bn_relu(deconv)
            ...
            deconv = Conv3DTranspose(filters=64, kernel_size=(6,7,7),
                          strides=(1,1,1), kernel_initializer='he_normal',
