...
deconv shortcut connections can account for any input/residual size (with padd)
"""
...
class Resnet3DBuilder(object):
    ...
    def build(input_shape, output_shape, block_fn, repetitions, reg_factor, mode='detection'):
        ...
        if mode == 'detection':
            ...
            #deconv_kernels = [(3,3,4), (3,3,4), (4,4,5), (5,5,6), (5,6,6)]

            deconv = _conv_bn_relu3D(deconv=True, filters=64, kernel_size=(3,3,4),
                          strides=(1,1,1), kernel_initializer='he_normal', padding='valid',
            ...
            deconv = _conv_bn_relu3D(deconv=True, filters=64, kernel_size=(4,4,5),
                          strides=(1,1,1), kernel_initializer='he_normal', padding='valid',
                          kernel_regularizer=l2(reg_factor))(deconv_block_output)
            deconv = _conv_bn_relu3D(deconv=True, filters=64, kernel_size=(5,5,6),
                          strides=(1,1,1), kernel_initializer='he_normal', padding='valid',
                          kernel_regularizer=l2(reg_factor))(deconv)
            ...
            deconv = _conv_bn_relu3D(deconv=True, filters=64, kernel_size=(5,6,6),
                          strides=(1,1,1), kernel_initializer='he_normal', padding='valid',
                          kernel_regularizer=l2(reg_factor))(deconv_block_output)
